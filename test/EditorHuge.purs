...
; ------------------------------------------------------------------------------
; editor plus macros two
; ------------------------------------------------------------------------------

(midnight-plus-macros-two
  '(
; ------------------------------------------------------------------------------
;
;      MIDNIGHT System
...
; ------------------------------------------------------------------------------
; editor plus macros three
; ------------------------------------------------------------------------------

(midnight-plus-macros-three
  '(
; ------------------------------------------------------------------------------
;
;      MIDNIGHT System
...
; ------------------------------------------------------------------------------
  ...
  (midnight-plus-macros-varlist-two
    (list-reverse ; reverse the order of the defines
      (defines-to-varlist midnight-plus-macros)))

  (midnight-plus-macros-varlist-three
    (list-reverse ; reverse the order of the defines
      (defines-to-varlist midnight-plus-macros)))
